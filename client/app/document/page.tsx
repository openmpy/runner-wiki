      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead>
          <tr className="font-bold">
            <td className="px-2 py-3">제목</td>
            <td className="px-2 py-3 w-1/6 text-center">카테고리</td>
            <td className="px-2 py-3 w-1/3">마지막 편집 시간</td>
          </tr>
        </thead>
        <tbody className="text-sm divide-y divide-gray-200">
          <tr className="hover:bg-gray-100 transition-colors">
            ...
            <td className="px-2 py-3 whitespace-nowrap text-gray-500 text-sm">
